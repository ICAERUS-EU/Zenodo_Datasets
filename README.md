...
| [UAV Canyelles Vineyard Dataset 2024-08-13](https://zenodo.org/records/15173656) | Esther Vera, Albert Pedraza, Aldo Sollazzo, Chirag Rangholia | 2025-05-08 | Crop monitoring dataset that includes RGB images, shape files, pointclouds and orthomosaics in multiple bands (RGB, NIR, G, RE, R, NDVI) and DEMs, captured with a DJI Mavic 3M UAV and processed with Metashape Agisoft. |
